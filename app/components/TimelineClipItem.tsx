...
export function TimelineClipItem({ clip, dragOffsetRef, handlers, processing, selected, timelineDuration }: { clip: TimelineClip; dragOffsetRef: MutableRefObject<number>; handlers: TimelineClipHandlers; processing?: boolean; selected: boolean; timelineDuration: number }) {
